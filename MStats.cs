    ...
    public class MStats : RustPlugin { 	
        ...
        private void createTablesOnConnect() {	
			try {
            	...
            	executeQuery("CREATE TABLE IF NOT EXISTS player_stats 			(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(255) NULL, player_ip VARCHAR(128) NULL, player_state INT(1) NULL DEFAULT '0', player_online_time BIGINT(20) DEFAULT '0', player_last_login TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE (`player_id`) );");   
            	executeQuery("CREATE TABLE IF NOT EXISTS player_xp 				(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_xp_total FLOAT DEFAULT '0', player_xp_spent FLOAT DEFAULT '0', PRIMARY KEY (`player_id`), UNIQUE KEY (`id`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_resource_gather (id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(255) NULL, resource VARCHAR(255) NULL, amount INT(32), date DATE NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `PlayerGather` (`player_id`,`resource`,`date`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_crafted_item 	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, item VARCHAR(128), amount INT(32), date DATE NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `PlayerItem` (`player_id`,`item`,`date`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_bullets_fired	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, bullet_name VARCHAR(128) NULL, bullets_fired INT(32) DEFAULT '1', weapon_name VARCHAR(128) NULL, date DATE NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `PlayerBullet` (`player_id`,`bullet_name`,`weapon_name`,`date`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_kill_animal		(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, animal VARCHAR(128), distance INT(11) NULL DEFAULT '0', weapon VARCHAR(128) NULL DEFAULT NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_kill			(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, killer_id BIGINT(20) NULL DEFAULT NULL, victim_id BIGINT(20) NULL DEFAULT NULL, bodypart VARCHAR(128), weapon VARCHAR(128), distance INT(11) NULL DEFAULT NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_death			(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, cause VARCHAR(128), count INT(11) NULL DEFAULT '1', date DATE NULL DEFAULT NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE (`player_id`,`date`,`cause`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_destroy_building(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, building VARCHAR(128), building_grade VARCHAR(128), weapon VARCHAR(128), time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_place_building 	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, building VARCHAR(128) NULL, amount INT(32) NULL DEFAULT '1', date DATE NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE (`player_id`,`date`,`building`) );");
            	executeQuery("CREATE TABLE IF NOT EXISTS player_place_deployable(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, deployable VARCHAR(128) NULL, amount INT(32) NULL DEFAULT '1', date DATE NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE (`player_id`,`date`,`deployable`) );");
				executeQuery("CREATE TABLE IF NOT EXISTS player_authorize_list	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, cupboard VARCHAR(128) NULL, access INT(32) NULL DEFAULT '0', time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE (`Cupboard`) );");
				executeQuery("CREATE TABLE IF NOT EXISTS player_chat_command	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, command VARCHAR(128) NULL, text VARCHAR(255) NULL DEFAULT NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
				executeQuery("CREATE TABLE IF NOT EXISTS player_connect_log		(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, state VARCHAR(128) NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
				if (LogChat() == true) {
					executeQuery("CREATE TABLE IF NOT EXISTS server_log_chat	(id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, player_id BIGINT(20) NULL DEFAULT NULL, player_name VARCHAR(128) NULL, player_ip VARCHAR(128), chat_message VARCHAR(255), admin INT(32) NULL DEFAULT '0', time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
				}
				if (LogConsole() == true) {
					executeQuery("CREATE TABLE IF NOT EXISTS server_log_console (id INT(11) NOT NULL DEFAULT NULL AUTO_INCREMENT, server_message VARCHAR(255) NULL DEFAULT NULL, time TIMESTAMP NULL DEFAULT NULL, PRIMARY KEY (`id`) );");
				}
				if (LogAiredrop() == true) {
